...
internal static partial class SocketsLog
{
    ...
    public static void ConnectionReadFin(ILogger logger, TransportConnection connection)
    {
    ...
    public static void ConnectionWriteFin(ILogger logger, TransportConnection connection, string reason)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
    ...
    public static void ConnectionWriteRst(ILogger logger, TransportConnection connection, string reason)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
    ...
    public static void ConnectionError(ILogger logger, TransportConnection connection, Exception ex)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
    ...
    [LoggerMessage(19, LogLevel.Debug, @"Connection id ""{ConnectionId}"" reset.", EventName = "ConnectionReset")]
    public static partial void ConnectionReset(ILogger logger, string connectionId);

    public static void ConnectionReset(ILogger logger, TransportConnection connection)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
    ...
    public static void ConnectionPause(ILogger logger, TransportConnection connection)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
    ...
    public static void ConnectionResume(ILogger logger, TransportConnection connection)
    {
        if (logger.IsEnabled(LogLevel.Debug))
        {
